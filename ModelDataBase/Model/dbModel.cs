...
namespace ModelDataBase.Model
{
    public partial class dbModel : DbContext
    {
        ...
        public virtual DbSet<DesiaseHistory> DesiaseHistory { get; set; }
        ...
        public virtual DbSet<TherapeuticAndDiagnosticMesuares> TherapeuticAndDiagnosticMesuares { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DesiaseHistory>()
                .HasMany(e => e.Patient)
                .WithOptional(e => e.DesiaseHistory)
                .HasForeignKey(e => e.IDDesiaseHistory);
            ...
            modelBuilder.Entity<Doctor>()
                .HasMany(e => e.TherapeuticAndDiagnosticMesuares)
                .WithRequired(e => e.Doctor)
                .HasForeignKey(e => e.IDDoctor)
                .WillCascadeOnDelete(false);
